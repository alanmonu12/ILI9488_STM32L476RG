##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.15.2] date: [Thu Dec 16 22:59:55 CST 2021] 
##########################################################################################################################
...
flash: 
	openocd -f interface/stlink.cfg -f target/stm32l4x.cfg -c "program ${BUILD_DIR}/$(PROJ_NAME).elf verify reset exit"
